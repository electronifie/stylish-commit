...
Prompt.prototype = {
  ...
  _askApplyConfirm: function (cb) {
    ...
    this._ask({
      ...
      choices: _.compact(['apply changes and cancel commit', 'apply changes and commit', 'ignore changes', 'abort commit'])
    }, function (response) {
      ...
      switch (response) {
        ...
        case 'abort commit': return cb(null, Prompt.Actions.ABORT_COMMIT, null); break;
        default: return cb(new Error('Unexpected response: ' + response)); break;
      }
    }.bind(this));
  },
